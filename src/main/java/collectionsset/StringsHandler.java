...
public class StringsHandler {
    ...
    public Set<String> filterUniqueStrings(Collection<String> stringCollection) {     // kiszűri az egyedi elemeket
        Set<String> uniqueStrings = new HashSet<>(stringCollection);                  // nem enged duplikációt, equals met-t hívja meg
        return uniqueStrings;
    }

    public Set<String> selectIdenticalStrings(Set<String> setA, Set<String> setB) { // különböző String halmazból kinyeri a közös elemeket
        setA.retainAll(setB);
