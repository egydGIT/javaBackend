...
public class CountryStatisticsTest {
    ...
    public void readFromFileTest() {
        ...
        assertEquals("Austria", countryStatistics.getCountryList().get(1).getCountryName());
        assertEquals(1, countryStatistics.getCountryList().get(5).getNumberOfNeighbours());
    }
    ...
    public void mostBorderCountriesTest() {
        ...
        assertEquals("Germany", countryStatistics.mostBorderCountries().getCountryName());
        assertEquals(8, countryStatistics.mostBorderCountries().getNumberOfNeighbours());
